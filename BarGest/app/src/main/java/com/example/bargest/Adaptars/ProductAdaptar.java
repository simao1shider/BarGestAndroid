...
public class ProductAdaptar extends RecyclerView.Adapter<ProductAdaptar.MyViewHolder>{
    ...
    public ProductAdaptar(Context context, ArrayList<Products> objetcs) {
    ...
    @NonNull
    @Override
    public ProductAdaptar.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
